...
Si Matias avisa que hay una actualización, correr de nuevo el mismo comando del paso 3 — detecta que ya está instalado y actualiza con `git pull` en vez de reinstalar todo.
